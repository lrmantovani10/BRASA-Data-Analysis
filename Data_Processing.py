'''
Instructions: 
Save Fb page data as Fb1.csv, post data as Fb2.csv (both in the Data fodler)
Save LinekdIn data as (Lk1, Lk2, Lk3).csv in the same folder as the Fb data, in the
following order: (*aggregate all - Mobile+Desktop, Organic+Sponsored)
Lk1 = Visitor (Data)
Lk2 = Updates
Lk3 = Followers
Typeform files can be named arbitrarily.
'''
import pandas as pd 
